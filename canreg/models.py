...
class PreliminaryQuestions(models.Model):
    patient = models.ForeignKey(Question, on_delete=models.CASCADE)
    confirmed_diagnosis = models.BooleanField(initial=False)
    history_suggests_cancer = models.BooleanField(initial=False)
    widely_metastatic_cancer = models.BooleanField(initial=False)
    diagnosable_at_location = models.BooleanField(initial=False)
    treatable_at_location = models.BooleanField(initial=False)
...
class DSTWorkup(models.Model):
    ...
    no_pathology = models.BooleanField(initial=False)
